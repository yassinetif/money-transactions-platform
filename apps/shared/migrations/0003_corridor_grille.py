        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination_content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'entity'), ('model', 'entity')), models.Q(('app_label', 'shared'),
                                                                                                                                                          ('model', 'country')), _connector='OR'),
                                                               on_delete=django.db.models.deletion.DO_NOTHING, related_name='corridor_destination_content_type', to='contenttypes.ContentType')),
                ('source_content_type', models.ForeignKey(limit_choices_to=models.Q(models.Q(('app_label', 'entity'), ('model', 'entity')),
                                                                                    models.Q(('app_label', 'shared'),
                                                                                             ('model', 'country')), _connector='OR'), on_delete=django.db.models.deletion.DO_NOTHING,
