...
AGENT_TRANSACTIONS = ['CASH_TO_CASH', 'CASH_TO_WALLET', 'RETRAIT_CASH', 'ACTIVATION_CARTE', 'CREDIT_COMPTE_ENTITE', 'DEBIT_COMPTE_ENTITE']
WALLET_TRANSACTIONS = ['WALLET_TO_CASH', 'CREATION_WALLET', 'WALLET_TO_WALLET']
